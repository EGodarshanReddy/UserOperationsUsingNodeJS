...
export const UserSchema = z.object({    
    ...
    // age: z.number({ invalid_type_error: "Age must be a number" }).min(25, "Age must be greater than 25").max(60, "Age must be less than 60"),
...
export const UpdateUserSchema = z.object({
  ...
  age: z.number({ invalid_type_error: "Age must be a number" }).min(25, "Age must be greater than 25").max(60, "Age must be less than 60").optional(),
